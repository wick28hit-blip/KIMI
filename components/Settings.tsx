                  ...
                  <div className="neu-flat p-2">
                      {reminders.filter(r => r.category === category).map((reminder, idx) => (
                          <div 
                            ...
                            className="p-4 flex items-center justify-between cursor-pointer hover:bg-black/5 dark:hover:bg-white/5 rounded-xl transition-colors mb-2 last:mb-0"
                          >
                      ...
                      <div className="p-3 mt-2 flex items-center justify-center border-t border-gray-100 dark:border-gray-700/50">
                          <button className="flex items-center gap-2 text-xs font-bold text-[#E84C7C]">
                             <PlusIcon /> Add new
                          </button>
                      </div>
                  </div>
        ...
        <div className="p-6">
            ...
            <div className="neu-flat p-4 border border-red-100 dark:border-red-900/30 mt-auto">
                ...
                <button 
                    ...
                    className="neu-btn w-full py-3 text-red-500 border-red-100"
                >
